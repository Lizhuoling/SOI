...
def resnet18(keep_prob=1.0, avg_pool=True, **kwargs):
...
def resnet24(keep_prob=1.0, avg_pool=True, **kwargs):
...
def resnet50(keep_prob=1.0, avg_pool=True, **kwargs):
...
def resnet101(keep_prob=1.0, avg_pool=True, **kwargs):
